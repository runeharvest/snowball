...
std::shared_ptr<User> UserSql::UserByLogin(const std::string &login)
{
...
std::shared_ptr<User> UserSql::UserByUID(int32_t uid)
{
...
bool UserSql::UserUpdate(const User &u)
{
...
void UserSql::BindCookie(int32_t uid, const std::string &cookie)
{
...
void UserSql::UnbindCookie(const std::string &cookie)
{
