...
void releaseLensFlare()
{
	delete LensFlare;
	LensFlare = NULL;
	Driver->deleteTextureFile(flareTexture1);
	flareTexture1 = NULL;
	Driver->deleteTextureFile(flareTexture3);
	flareTexture3 = NULL;
	Driver->deleteTextureFile(flareTexture4);
	flareTexture4 = NULL;
	Driver->deleteTextureFile(flareTexture5);
	flareTexture5 = NULL;
	Driver->deleteTextureFile(flareTexture6);
	flareTexture6 = NULL;
	Driver->deleteTextureFile(flareTexture7);
	flareTexture7 = NULL;
}
